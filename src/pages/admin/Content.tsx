    ...
    sections: [
      {
        ...
        fields: [
          { key: "logo", label: "Logo Image", type: "image", default: "/images/logo-transparent.png" },
          ...
          { key: "bg_from", label: "Navbar Gradient Top (dark, hex)", type: "text", default: "#93c5fd" },
          { key: "bg_to", label: "Navbar Gradient Bottom (light, hex)", type: "text", default: "#dbeafe" },
